...
class GrpcRate extends GeneratedMessage {
  ...
  GrpcRate() : super();
  GrpcRate.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GrpcRate.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
...
class GrpcCurrency extends GeneratedMessage {
  ...
  GrpcCurrency() : super();
  GrpcCurrency.fromBuffer(List<int> i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromBuffer(i, r);
  GrpcCurrency.fromJson(String i, [ExtensionRegistry r = ExtensionRegistry.EMPTY]) : super.fromJson(i, r);
  ...
  static GrpcCurrency getDefault() {
    if (_defaultInstance == null) _defaultInstance = new _ReadonlyGrpcCurrency();
    return _defaultInstance;
  }
